...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------- |
| **Gironimo** 🦒        | Open-source **human-gated AI development system**. Converts specifications into architecture and implementation using specialized LLMs running locally or in the cloud.              | [Repository](https://github.com/SlopOps/gironimo) • [Website](https://gironimo.ai)                |
